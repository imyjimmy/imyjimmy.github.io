...
// athenaHealth logo
import logoAthenaHealth from '@/images/logos/athenaHealth.png'
import logoOBI from '@/images/logos/obiLogo.png'
import logoAnalgesic from '@/images/logos/analgesicLogo.png'
...
function Resume() {
  let resume = [
    ...
    {
      company: 'OBI Brigham and Women\'s',
    ...
    {
      company: 'Analgesic Solutions',
      // title: 'Software Engineer,\nClinical Informatics Analyst',
      titles: ['Software Engineer', 'Clinical Informatics Analyst'],
      logo: logoAnalgesic,
      start: '2017',
      end: '2019'
    },
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Jimmy Fan Zhang - Software designer, founder, and amateur astronaut
        </title>
        <meta
          name="description"
          content="I’m Jimmy, a software developer with an eye for design."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software developer with an 👁 for design. Expert in React, Javascript, Typescript
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            👋   
            I’m Jimmy, a frontend software developer currently working on building and maintaining a robust design system @athenaHealth.
          </p>
